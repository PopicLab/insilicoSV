...
```
python utils.py --genome_vcf {path to summary vcf} --query_loc {query genome locus in mutated reference} --query_chrom {corresponding chromosome}
```
This function is currently only amenable to edited references containing DELs, DUPs, and INVs.
